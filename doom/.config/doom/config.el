...
;; accept. For example:
;;
(setq doom-font (font-spec :family "AtkinsonHyperLegibleMono Nerd Font Regular" :size 25 :weight 'semi-light)
      doom-variable-pitch-font (font-spec :family "AtkinsonHyperLegibleMono Nerd Font Regular" :size 30))
;;
